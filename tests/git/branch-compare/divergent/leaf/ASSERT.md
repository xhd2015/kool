...
- Stdout contains "main and a has 1 files difference"
...
func Assert(t *testing.T, req *Request, resp *Response, err error) {
	...
	if !strings.Contains(resp.Stdout, "main and a has 1 files difference") {
		t.Fatalf("expected stdout to contain 'main and a has 1 files difference', got:\n%s", resp.Stdout)
	}
